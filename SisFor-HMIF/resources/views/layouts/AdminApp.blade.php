...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-custom" style="background: #DFD7BF">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/adminHM') }}">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('divisi.index') }}">{{ __('Divisi') }}</a>
                        </li>
                    </ul>
